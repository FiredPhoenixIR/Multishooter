...
//DECLARE_CYCLE_STAT(TEXT("StartActionByName"), STAT_StartActionByName, STATGROUP_MST);
...
bool USActionComponent::StartActionByName(AActor* Instigator, FGameplayTag ActionName)
{
	...
	DECLARE_SCOPE_CYCLE_COUNTER(TEXT("StartActionByName"), StartActionByName, STATGROUP_MST);
